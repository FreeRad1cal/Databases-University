...
export class AuthService {
  ...
  register(person: Person): Observable<HttpResponse<Person>> {
    const registerUrl = `${this.personnelApi}/people`;
    return this.httpClient.post<Person>(registerUrl, person, {observe: 'response'});
  }
}
